...
## Data Preparation
1. Download the Things-EEG dataset from the [OSF repository](https://osf.io/anp5v/files/osfstorage) and put them in the `data` dir. (We provided the processed data on [BaiduNetdisk](https://pan.baidu.com/s/1p_5EtKmojmpwXr2_LoaxTA?pwd=huhe) and [Huggingface](https://huggingface.co/datasets/Haitao999/things-eeg))
